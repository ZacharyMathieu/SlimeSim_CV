class Environment:
    ...
    __pheromone_grid: self.__pheromone_grid
    __seek_pheromone_timer = 0

    def Environment(self):
        self.__slime_vector = SlimeVector()
        self.__env_data = EnvironmentData()
        self.__pheromone_grid = self.__pheromone_grid(self.__env_data.grid_width, self.__env_data.grid_height,
                                                      self.__env_data)
        self.generate_random_slime(self.__env_data.get_slime_count())
    ...
    #       + spacing + " Width: " + self.__env_data.grid_width + std::endl
    #       + spacing + " Height: " + self.__env_data.grid_height + std::endl
    ...
    def __update_param(self, param: InputParam) -> None:
        if param.name == "display_pheromones":
            if self.__env_data.display_pheromones != param.value_bool:
                print("display_pheromones set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.display_slime != param.value_bool:
                print("display_slime set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.display_slime_size != param.value_number:
                print("display_slime_size set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.display_slime_opacity != param.value_number:
                print("display_slime_opacity set to : [" + param.value_number + "]\n")
        ...
        # ////        print("display_inactive_pheromone_color not yet implemented\n")
            ...
            if self.__env_data.grid_width != param.value_number:
                print("grid_width set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.random_natural_pheromones_count != param.value_number:
                print("random_natural_pheromones_count set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.natural_pheromones_strength != param.value_number:
                print("natural_pheromones_strength set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_count != param.value_number:
                print("slime_count set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_speed != param.value_number:
                print("slime_speed set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_avoid_walls != param.value_bool:
                print("slime_avoid_walls set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.slime_wall_detection_range != param.value_number:
                print("slime_wall_detection_range set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_wall_turn_angle != param.value_number:
                print("slime_wall_turn_angle set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_seek_pheromones != param.value_bool:
                print("slime_seek_pheromones set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.slime_seek_pheromones_period != param.value_number:
                print("slime_seek_pheromones_period set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_pheromone_detection_range != param.value_number:
                print("slime_pheromone_detection_range set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_pheromone_turn_angle != param.value_number:
                print("slime_pheromone_turn_angle set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_pheromone_level != param.value_number:
                print("slime_pheromone_level set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_ignore_self_pheromone != param.value_bool:
                print("slime_ignore_self_pheromone set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.slime_align_direction != param.value_bool:
                print("slime_align_direction set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.slime_other_detection_range != param.value_number:
                print("slime_other_detection_range set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_align_turn_angle != param.value_number:
                print("slime_align_turn_angle set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_random_rotation_chance != param.value_number:
                print("slime_random_rotation_chance set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_random_rotation_angle != param.value_number:
                print("slime_random_rotation_angle set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_bias_direction != param.value_bool:
                print("slime_bias_direction set to : [" + param.value_bool + "]\n")
            ...
            if self.__env_data.slime_bias_direction_x != param.value_number:
                print("slime_bias_direction_x set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_bias_direction_y != param.value_number:
                print("slime_bias_direction_y set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.slime_bias_rotation_angle != param.value_number:
                print("slime_bias_rotation_angle set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.pheromone_max_level != param.value_number:
                print("pheromone_max_level set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.pheromone_high_level_diffusion_multiplier != param.value_number:
                print("pheromone_high_level_diffusion_multiplier set to : [" + param.value_number + "]")
            ...
            if self.__env_data.pheromone_low_level_diffusion_multiplier != param.value_number:
                print("pheromone_low_level_diffusion_multiplier set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.pheromone_diffusion_constant != param.value_number:
                print("pheromone_diffusion_constant set to : [" + param.value_number + "]\n")
            ...
            if self.__env_data.pheromone_max_level_reset_value != param.value_number:
                print("pheromone_max_level_reset_value set to : [" + param.value_number + "]\n")
    ...
    def getEnvironmentData(self) -> Environment:
